...
const AdminPanel = ({ onLogout }) => {
  ...
  const [activeTab, setActiveTab] = useState('inquiries'); // 'inquiries' or 'properties'
            ...
            <div className="admin-header">
              <div className="admin-header-content">
                <div className="admin-title-section">
                  ...
                  <p className="text-muted">Manage inquiries and properties</p>
                </div>
                <div className="admin-actions">
                  <div className="admin-user-info">
                    ...
                    <div className="admin-user-details">
                      <span className="admin-username">Mohamad Ahmad</span>
            ...
            <ul className="nav nav-tabs admin-tabs mb-4">
              <li className="nav-item">
                ...
                >
                  ...
                  Contact Inquiries
                  {inquiries.filter(inq => !inq.isRead).length > 0 && (
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="inquiries-list">
                <div className="inquiries-header mb-3">
                  <h5>Contact Inquiries ({inquiries.length})</h5>
                </div>
                {inquiries.length === 0 ? (
